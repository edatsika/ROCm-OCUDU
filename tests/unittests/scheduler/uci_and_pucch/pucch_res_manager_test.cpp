                                                         ...
                                                         std::optional<pucch_csi_resource_id> csi_res_id_override = {})
  {
    ...
    if (sr_res_id_override.has_value() or csi_res_id_override.has_value()) {
      ...
      ue_cell.serv_cell_cfg.ul_config->init_ul_bwp.pucch_cfg =
          config_helpers::build_pucch_config(cell_cfg.params, cell_cfg.init_bwp, ue_cell.init_bwp());
      ue_cell.serv_cell_cfg.csi_meas_cfg =
          config_helpers::build_csi_meas_config(cell_cfg.params, cell_cfg.init_bwp, ue_cell.init_bwp());
    }
...
TEST_F(test_pucch_resource_manager, reserve_harq_set_0_until_exhausted)
{
  ...
  for (unsigned i = 0; i != res_set_0_size; ++i) {
    ...
    ASSERT_EQ(
        &t_bench.cell_cfg.init_bwp.ul.pucch.resources[pucch_cfg_0().pucch_res_set[0].pucch_res_id_list[i].cell_res_id],
        record.resource);
    guard.commit();
  }
...
TEST_F(test_pucch_resource_manager, get_next_harq_different_slot)
{
  ...
  ASSERT_EQ(
      &t_bench.cell_cfg.init_bwp.ul.pucch.resources[pucch_cfg_0().pucch_res_set[0].pucch_res_id_list[0].cell_res_id],
      record.resource);
}
...
TEST_F(test_pucch_resource_manager, reserve_harq_set_1_until_exhausted)
{
  ...
  for (unsigned i = 0; i != res_set_1_size; ++i) {
    ...
    ASSERT_EQ(&t_bench.cell_cfg.init_bwp.ul.pucch.resources[cell_res_id], record.resource);
    guard.commit();
  }
...
TEST_F(test_pucch_resource_manager, allocate_csi_resource)
{
  ...
  ASSERT_EQ(&t_bench.cell_cfg.init_bwp.ul.pucch.resources[expected_csi_cell_res_id], res);
}
...
TEST_F(test_pucch_resource_manager, release_and_reallocate_csi_resource)
{
  ...
  ASSERT_EQ(&t_bench.cell_cfg.init_bwp.ul.pucch.resources[expected_csi_cell_res_id], res_reallocation);
}
...
TEST_F(test_pucch_resource_manager, test_allocation_sr_resource)
{
  ...
  ASSERT_EQ(&t_bench.cell_cfg.init_bwp.ul.pucch.resources[expected_sr_cell_res_id], sr_resource);
}
...
TEST_F(test_pucch_resource_manager, test_allocation_release_sr_resource)
{
  ...
  const unsigned expected_sr_cell_res_id = pucch_cfg_0().sr_res_list[0].pucch_res_id.cell_res_id;
  ASSERT_EQ(&t_bench.cell_cfg.init_bwp.ul.pucch.resources[expected_sr_cell_res_id], sr_resource_ue2);
}
...
TEST_F(test_pucch_res_manager_multiple_cfg, test_2_ues_2_cfgs_alloc_f1_only)
{
  ...
  ASSERT_EQ(&t_bench->cell_cfg.init_bwp.ul.pucch.resources[0], record_ue_0.resource);
  ...
  ASSERT_EQ(&t_bench->cell_cfg.init_bwp.ul.pucch.resources[8], record_ue_1.resource);
  ...
  ASSERT_EQ(&t_bench->cell_cfg.init_bwp.ul.pucch.resources[1], record_ue_2.resource);
  ...
  ASSERT_EQ(&t_bench->cell_cfg.init_bwp.ul.pucch.resources[9], record_ue_3.resource);
...
TEST_F(test_pucch_res_manager_multiple_cfg, test_2_ues_2_cfgs_alloc_f2_only)
{
  ...
  ASSERT_EQ(0U, record_ue_0.pucch_res_indicator);
  ASSERT_EQ(&t_bench->cell_cfg.init_bwp.ul.pucch.resources[18], record_ue_0.resource);
  ...
  ASSERT_EQ(0U, record_ue_1.pucch_res_indicator);
  ASSERT_EQ(&t_bench->cell_cfg.init_bwp.ul.pucch.resources[26], record_ue_1.resource);
  ...
  ASSERT_EQ(&t_bench->cell_cfg.init_bwp.ul.pucch.resources[19], record_ue_2.resource);
  ...
  ASSERT_EQ(1U, record_ue_3.pucch_res_indicator);
  ASSERT_EQ(&t_bench->cell_cfg.init_bwp.ul.pucch.resources[27], record_ue_3.resource);
...
TEST_F(test_pucch_res_manager_multiple_cfg, test_2_ues_2_cfgs_alloc_specific_f2)
{
  ...
  ASSERT_EQ(&t_bench->cell_cfg.init_bwp.ul.pucch.resources[23], res_ue_0);
  ...
  ASSERT_EQ(&t_bench->cell_cfg.init_bwp.ul.pucch.resources[31], res_ue_1);
...
TEST_F(test_pucch_res_manager_multiple_cfg, test_8_ues_2_cfgs_allocate_all_resources)
{
  ...
  ASSERT_EQ(&t_bench->cell_cfg.init_bwp.ul.pucch.resources[1], record_ue_6.resource);
  ...
  ASSERT_EQ(&t_bench->cell_cfg.init_bwp.ul.pucch.resources[4], record_ue_7.resource);
...
TEST_F(test_pucch_res_manager_multiple_cfg, test_8_ues_2_cfgs_allocate_all_resources_f2)
{
  ...
  ASSERT_EQ(&t_bench->cell_cfg.init_bwp.ul.pucch.resources[9], record_ue_6.resource);
  ...
  ASSERT_EQ(1U, record_ue_7.pucch_res_indicator);
  ASSERT_EQ(&t_bench->cell_cfg.init_bwp.ul.pucch.resources[12], record_ue_7.resource);
...
TEST_F(test_pucch_res_manager_multiple_cfg, test_4_ues_2_cfgs_allocate_sr)
{
  ...
  ASSERT_EQ(&t_bench->cell_cfg.init_bwp.ul.pucch.resources[16], sr_resource);
  ...
  // Allocate SR to another UE and verify it is assigned a resource.
  const pucch_resource* sr_resource_ue2 = guard2.reserve_sr_resource();
  ASSERT_EQ(&t_bench->cell_cfg.init_bwp.ul.pucch.resources[16], sr_resource_ue2);
  ...
  ASSERT_EQ(&t_bench->cell_cfg.init_bwp.ul.pucch.resources[17], sr_resource_ue1);
  ...
  ASSERT_EQ(&t_bench->cell_cfg.init_bwp.ul.pucch.resources[17], sr_resource_ue3);
...
TEST_F(test_pucch_res_manager_multiple_cfg, test_4_ues_2_cfgs_allocate_csi)
{
  ...
  ASSERT_EQ(&t_bench->cell_cfg.init_bwp.ul.pucch.resources[34], csi_resource);
  ...
  ASSERT_EQ(&t_bench->cell_cfg.init_bwp.ul.pucch.resources[34], csi_resource_ue2);
  ...
  ASSERT_EQ(&t_bench->cell_cfg.init_bwp.ul.pucch.resources[35], csi_resource_ue1);
  ...
  ASSERT_EQ(&t_bench->cell_cfg.init_bwp.ul.pucch.resources[35], sr_resource_ue3);
