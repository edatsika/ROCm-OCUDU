...
public:
  ...
  void handle_cho_cancel_required(ue_index_t                 ue_index,
                                   const nr_cell_global_id_t& target_cgi) override;
  void handle_handover_success_required(ue_index_t ue_index, const nr_cell_global_id_t& cgi) override;
