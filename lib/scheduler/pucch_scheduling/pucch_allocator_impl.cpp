                                        ...
                                        bool                  adjust_prbs) const
{
  ...
  switch (pucch_res.format) {
    ...
    case pucch_format::FORMAT_2: {
      ...
      format_2.n_id_scrambling = cell_cfg.params.pci;
      // \f$N_{ID}^0\f$ as per TS 38.211, Section 6.4.1.3.2.1.
      format_2.n_id_0_scrambling = cell_cfg.params.pci;
    ...
    case pucch_format::FORMAT_3: {
      ...
      // \f$n_{ID}\f$ as per Section 6.3.2.5.1 and 6.3.2.6.1, TS 38.211.
      format_3.n_id_scrambling   = cell_cfg.params.pci;
      format_3.n_id_0_scrambling = cell_cfg.params.pci;
    ...
    case pucch_format::FORMAT_4: {
      ...
      // \f$n_{ID}\f$ as per Section 6.3.2.5.1 and 6.3.2.6.1, TS 38.211.
      format_4.n_id_scrambling   = cell_cfg.params.pci;
      format_4.n_id_0_scrambling = cell_cfg.params.pci;
