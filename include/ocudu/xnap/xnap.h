...
public:
  ...
  virtual void handle_cho_cancel_required(ue_index_t                 ue_index,
                                          const nr_cell_global_id_t& target_cgi) = 0;
  ...
  virtual void handle_handover_success_required(ue_index_t ue_index, const nr_cell_global_id_t& cgi) = 0;
...
public:
  ...
  virtual void on_handover_success_received(ue_index_t source_ue_index, peer_xnap_ue_id_t winner_peer_xnap_ue_id) = 0;
